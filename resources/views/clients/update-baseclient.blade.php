            ...
            <div class="widget-content widget-content-area br-6">
                ...
                <div class="col-lg-12 col-12 layout-spacing">
                    <div class="statbox widget box box-shadow">
                        <form class="general_form" method="POST" action="{{url($prefix.'/update-base-client')}}"
                            id="update_baseclient">
                            ...
                            <div class="form-row mb-0">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control" name="client_name" placeholder=""
                                        value="{{old('client_name',isset($baseClient->client_name)?$baseClient->client_name:'')}}">
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="exampleFormControlInput2">GST Number<span
                                            class="text-danger">*</span></label>
                                    <input type="text" class="form-control" name="gst_no" placeholder=""
                                        value="{{old('gst_no',isset($baseClient->gst_no)?$baseClient->gst_no:'')}}">
                                </div>
                            </div>
                            <div class="form-row mb-0">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control" name="pan" placeholder=""
                                        value="{{old('pan',isset($baseClient->pan)?$baseClient->pan:'')}}">
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="exampleFormControlInput2">TAN<span class="text-danger">*</span></label>
                                    <input type="text" class="form-control" name="tan" placeholder=""
                                        value="{{old('tan',isset($baseClient->tan)?$baseClient->tan:'')}}">
                                </div>
                            </div>
