        ...
        <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
            ...
            <div class="widget-content widget-content-area br-6">
                ...
                <div class="main-table table-responsive">
                    @include('payment-settlement.payment-settled-ajax')
                </div>
            </div>
        </div>
    </div>
                ...
                <form id="settlement_form">
                    ...
                    <div class="form-row mb-0">
                        <div class="form-group form-group-sm col-md-4">
                            ...
                            <input type="date" class="form-control" id="date_of_deposite" name="date_of_deposite" value="">
                        </div>
                        <div class="form-group form-group-sm col-md-4">
                    ...
                    <div class="form-row mb-0">
                        <div class="form-group form-group-sm col-md-4">
                            ...
                            <input type="number" class="form-control" id="amount_deposite" name="amount_deposite" value="">
                        </div>
