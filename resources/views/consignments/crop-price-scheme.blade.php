        ...
        <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
            <div class="page-header">
                <nav class="breadcrumb-one" aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0);">Crop Price Scheme</a></li>
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-12">
                            ...
                            <select class="form-control my-select2" id="crop_change" name="crop_id" tabindex="-1">
                                ...
                                <option value="{{$crop->id}}" crop-price="{{$crop->crop_price}}">{{$crop->crop_name}}
                                </option>
                                @endforeach
                            </select>
                        </div>
...
$('#add_crop_scheme').submit(function(e) {
    e.preventDefault();
