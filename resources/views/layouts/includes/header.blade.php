...
<link href="{{asset('newasset/assets/css/components/tabs-accordian/custom-tabs.css')}}" rel="stylesheet"
      type="text/css"/>
...
{{--<link href="{{asset('assets/css/style.css')}}" rel="stylesheet" type="text/css"/>--}}
{{--<link href="{{asset('assets/css/newcss/bootstrap.min.css')}}" rel="stylesheet" type="text/css" />--}}
{{--<link href="{{asset('assets/css/newcss/structure.css')}}" rel="stylesheet" type="text/css" />--}}
{{--<link href="{{asset('assets/css/newcss/light.css')}}" rel="stylesheet" type="text/css" />--}}
