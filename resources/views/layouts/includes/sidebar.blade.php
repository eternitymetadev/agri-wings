<ul class="list-unstyled menu-categories" id="accordionExample">
    ...
    ?>
    <li class="menu">
        <a href="{{$prefixurl.'battery-list'}}" data-active="<?php if($segment == 'battery-list'){?>true<?php }?>"
            class="dropdown-toggle">
            <div class="@if(str_contains($currentURL, 'battery-list')) active @endif">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                    stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                    class="feather feather-command">
                    <path
    ...
    ?>
    <li class="menu">
        <a href="{{$prefixurl.'crop-scheme-list'}}" data-active="<?php if($segment == 'crop-scheme-list'){?>true<?php }?>"
            class="dropdown-toggle">
            <div class="@if(str_contains($currentURL, 'crop-scheme-list')) active @endif">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                    stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                    class="feather feather-users">
                    <path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path>
    ...
    <li class="menu">
        <a href="{{$prefixurl.'consignments'}}"
            data-active="<?php if($segment == 'consignments'){?>true<?php }?>" class="dropdown-toggle">
            <div class="@if(str_contains($currentURL, 'postal-code')) active @endif">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                    stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                    class="feather feather-users">
   ...
   if($authuser->role_id == 2 || $authuser->role_id ==3 || $authuser->role_id ==5){ ?>
    ...
    <li class="menu">
        <a href="#billing_client" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
            <div class="@if(str_contains($currentURL, 'bulk-import')) active @endif">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                    stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                    class="feather feather-clipboard">
                    <path d="M16 4h2a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h2"></path>
